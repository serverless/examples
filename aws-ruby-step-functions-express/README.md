...
Clearing previous build ruby layer build
[ '4.0' ]
Installing gem using local bundler
Zipping the gemfiles to aws-ruby-step-functions-express/.serverless/ruby_layer/gemLayer.zip
Configuring Layer and GEM_PATH to the functions
✓ State machine "myStateMachine" definition is valid
Uploading CloudFormation file to S3...
Uploading artifacts...
Uploading service aws-ruby-step-functions-express.zip file to S3 (971.85 KB)...
Uploading service gemLayer.zip file to S3 (553.86 KB)...
Validating template...
Updating Stack...
...
Service Information
service: aws-ruby-step-functions-express
stage: dev
region: eu-west-1
stack: aws-ruby-step-functions-express-dev
resources: 16
api keys:
  None
endpoints:
functions:
  send-email: aws-ruby-step-functions-express-dev-send-email
layers:
  gem: arn:aws:lambda:your-region:XXXXXXXXXXX:layer:aws-ruby-step-functions-express-dev-ruby-bundle:2
