...
| **[Golang Serverless Starter](https://github.com/EliuX/serverless-migrate-plugin/tree/master/example)** <br/> Echo function with API Gateway that uses TravisCI automatic deployment | [EliuX](http://github.com/EliuX) |
