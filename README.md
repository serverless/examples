...
| **[Golang Serverless Starter](https://github.com/emilhein/golang-serverless-starter)** <br/> Echo function with API Gateway that uses TravisCI automatic deployment | [emilhein](http://github.com/emilhein) |
