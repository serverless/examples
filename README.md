...
| Example | Runtime  |
|:--------------------------- |:-----|
| [Samueleresca Test](https://github.com/serverless/examples/tree/master/aws-dotnet-rest-api-with-dynamodb/src/DotNetServerless.Lambda/bin/release/netcoreapp2.1/publish)  | nodeJS |
| [Samueleresca Test](https://github.com/serverless/examples/tree/master/aws-dotnet-rest-api-with-dynamodb/src/DotNetServerless.Lambda)  | nodeJS |
