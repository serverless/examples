...
| [Azure Node Echo Line Bot](https://github.com/serverless/examples/tree/master/azure-node-line-bot) <br/> Azure Functions sample Line Bot for the Serverless framework | nodeJS |
...
| [Azure Node Telegram Bot](https://github.com/serverless/examples/tree/master/azure-node-telegram-bot) <br/> Azure Functions sample Telegram Bot for the Serverless framework | nodeJS |
