...
| **[Aws Node Example For S3 Signed Uploads](https://github.com/kalinchernev/aws-node-signed-uploads)** <br/> Upload files bigger than 10MB with S3 signed uploads. Unit tested with Jest. | [kalinchernev](http://github.com/kalinchernev) |
