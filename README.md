...
| [Aws Nodejs Typescript](https://github.com/serverless/examples/tree/master/aws-nodejs-typescript) <br/> Deploy a NodeJS function running on AWS Lambda with Typescript | nodeJS |
