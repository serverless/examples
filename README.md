...
| **[AWS CloudWatch Proxy](https://github.com/abbasdgr8/cloudwatch-proxy)** <br/> Logging adapter that consumes log streams from AWS CloudWatch, streams them to other log destinations. Also capable of identifying alerts and notifying via Slack and Email | [abbasdgr8](http://github.com/abbasdgr8) |
<!-- AUTO-GENERATED-CONTENT:END -->
